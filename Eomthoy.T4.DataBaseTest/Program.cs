...
namespace Eomthoy.T4.DataBaseTest
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            SqlHelper.connString = @"Server=.;DataBase=RecordDB;User Id=sa;Password=123456;";
            string sql = "select * from sys.tables where name like '%%' and name in ('Conn_PCase_BodyCheck', 'AllergyHistory')";
